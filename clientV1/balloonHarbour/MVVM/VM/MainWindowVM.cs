...
namespace balloonHarbour.MVVM.VM {
    public class MainWindowVM {
        ...
        private AccountModel _CurrentProfile;
        public MainWindowVM(MainWindow view) {
            ...
            CurrentProfile = new AccountModel("Username");
        ...
        #endregion
        internal AccountModel CurrentProfile { get => _CurrentProfile; set => _CurrentProfile = value; }
    }
}
